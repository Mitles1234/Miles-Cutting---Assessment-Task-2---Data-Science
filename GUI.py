...
Location = StringVar()
WindSpeed = tk.BooleanVar()
GustSpeed = tk.BooleanVar()
Buildings = tk.BooleanVar()
...
def Home():
    ...
    Albury = Radiobutton(frame1, text='Albury', variable=Location, value='Albury', cursor="hand2", command=Graph)
    CoffsHarbour = Radiobutton(frame1, text='Coffs Harbour', variable=Location, value='Coffs Harbour', cursor="hand2", command=Graph)
    Newcastle = Radiobutton(frame1, text='Newcastle', variable=Location, value='Newcastle', cursor="hand2", command=Graph)
    Penrith = Radiobutton(frame1, text='Penrith', variable=Location, value='Penrith', cursor="hand2", command=Graph)
    ...
    WindSpeedCheck = Checkbutton(frame1, text = "Wind Speed", font=("Helvetica", 10, "bold"), 
                                 variable=WindSpeed, onvalue=WindSpeed.set(True), offvalue=WindSpeed.set(False), width = 20)
    GustSpeedCheck = Checkbutton(frame1, text = "Gust Speed", font=("Helvetica", 10, "bold"), 
                                 variable=GustSpeed, onvalue=GustSpeed.set(True), offvalue=GustSpeed.set(False), width = 20)
    BuildingsCheck = Checkbutton(frame1, text = "Buildings", font=("Helvetica", 10, "bold"), 
                                 variable=Buildings, onvalue=Buildings.set(True), offvalue=Buildings.set(False), width = 20)
